...
* v0.5.0: Fix Windows OS detection (Helm 3/4); skip cloud-init and SSH access credentials for Windows; default additional disk bus to sata for Windows when not overridden
